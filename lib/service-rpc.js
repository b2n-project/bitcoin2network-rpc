...
var B2NServiceRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof B2NServiceRPC)) return new B2NServiceRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 9070
  ...
  this.defaultFee = (opts.defaultFee !== undefined) ? opts.defaultFee : 0.01
...
B2NServiceRPC.prototype.reset = function (opts) {
...
B2NServiceRPC.prototype.save = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype.getViewKey = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype.getSpendKeys = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.getMnemonicSeed = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
B2NServiceRPC.prototype.getStatus = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype.getAddresses = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype.createAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.deleteAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
B2NServiceRPC.prototype.getBalance = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.address = opts.address || ''
...
B2NServiceRPC.prototype.getBlockHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.getTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
    opts.blockHash = opts.blockHash || false
...
B2NServiceRPC.prototype.getUnconfirmedTransactionHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses || []
...
B2NServiceRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.newTransfer = function (address, amount) {
  return {
    address: address,
...
B2NServiceRPC.prototype.sendTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    var that = this
    opts = opts || {}
    opts.addresses = opts.addresses = []
...
B2NServiceRPC.prototype.createDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.addresses = opts.addresses = []
    opts.transfers = opts.transfers || false
...
B2NServiceRPC.prototype.getDelayedTransactionHashes = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype.deleteDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.sendDelayedTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.transactionHash = opts.transactionHash || false
...
B2NServiceRPC.prototype.sendFusionTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.estimateFusion = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    opts.threshold = opts.threshold || this.defaultFusionThreshold
    opts.addresses = opts.addresses || []
...
B2NServiceRPC.prototype.createIntegratedAddress = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
B2NServiceRPC.prototype.getFeeInfo = function () {
  return this.getNodeFeeInfo()
}

B2NServiceRPC.prototype.getNodeFeeInfo = function () {
  return new Promise((resolve, reject) => {
...
B2NServiceRPC.prototype._postToWalletd = function (method, params) {
  return new Promise((resolve, reject) => {
