...
var bitcoin2networkdRPC = function (opts) {
  opts = opts || {}
  if (!(this instanceof bitcoin2networkdRPC)) return new bitcoin2networkdRPC(opts)
  this.host = opts.host || '127.0.0.1'
  this.port = opts.port || 19935
  this.timeout = opts.timeout || 2000
  this.ssl = opts.ssl || false
}

bitcoin2networkdRPC.prototype.getBlocks = function (opts) {
...
bitcoin2networkdRPC.prototype.getBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
bitcoin2networkdRPC.prototype.getTransactionPool = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getBlockCount = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getBlockHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
bitcoin2networkdRPC.prototype.getBlockTemplate = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.submitBlock = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getLastBlockHeader = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getBlockHeaderByHash = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.hash) return reject(new Error('must specify hash'))
...
bitcoin2networkdRPC.prototype.getBlockHeaderByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!opts.height) return reject(new Error('must specify height'))
...
bitcoin2networkdRPC.prototype.getCurrencyId = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getHeight = function () {
  return this.height()
}

bitcoin2networkdRPC.prototype.height = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getInfo = function () {
  return this.info()
}

bitcoin2networkdRPC.prototype.info = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.feeInfo = function () {
  return this.fee()
}

bitcoin2networkdRPC.prototype.fee = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.getTransactions = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getPeers = function () {
  return this.peers()
}

bitcoin2networkdRPC.prototype.peers = function () {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype.sendRawTransaction = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getWalletSyncData = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getGlobalIndexesForRange = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getTransactionsStatus = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getBlocks = function (opts) { // getblocks
...
bitcoin2networkdRPC.prototype.queryBlocks = function (opts) { // queryblocks
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    return reject(new Error('This RPC call is not implemented'))
  })
...
bitcoin2networkdRPC.prototype.queryBlocksDetailed = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.queryBlocksLite = function (opts) {
  // *first 10 blocks id goes sequential, next goes in pow(2,n) offset, like 2, 4, 8, 16, 32, 64 and so on, and the last one is always genesis block */
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
bitcoin2networkdRPC.prototype.getIndexes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getRandomOutputs = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getPoolChanges = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getPoolChangesLite = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (opts.tailBlockHash === undefined) return reject(new Error('must supply a tail block hash'))
    if (!Array.isArray(opts.knownTransactionHashes)) return reject(new Error('must supply an array of known transaction hashes'))
...
bitcoin2networkdRPC.prototype.getBlockDetailsByHeight = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getBlocksDetailsByHeights = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getBlocksDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
    if (!Array.isArray(opts.blockHashes)) return reject(new Error('must supply an array of block hashes'))
...
bitcoin2networkdRPC.prototype.getBlocksHashesByTimestamps = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getTransactionDetailsByHashes = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype.getTransactionHashesByPaymentId = function (opts) {
  return new Promise((resolve, reject) => {
    opts = opts || {}
...
bitcoin2networkdRPC.prototype._get = function (method) {
  return new Promise((resolve, reject) => {
...
bitcoin2networkdRPC.prototype._post = function (method, params) {
  return new Promise((resolve, reject) => {
    if (method.length === 0) return reject(new Error('no method supplied'))
    params = params || {}
...
bitcoin2networkdRPC.prototype._rawPost = function (endpoint, body) {
  return new Promise((resolve, reject) => {
...
module.exports = bitcoin2networkdRPC
